...
<!-- ::: -->
<!-- ::: -->
```{r echo=FALSE, movingMag, out.width='70%', fig.show='hold', fig.align="center", auto_pdf=TRUE, fig.cap="A bar magnet (right) and a current loop and itss associated magnetic field (left.)"}
...
```{r echo=FALSE, ancesSummary, out.width='70%', fig.show='hold', fig.align="center", auto_pdf=TRUE, fig.cap="A bar magnet (right) and a current loop and itss associated magnetic field (left.)"}
...
```{r echo=FALSE, LCRsymbols, out.width='70%', fig.show='hold', fig.align="center", auto_pdf=TRUE, fig.cap="A bar magnet (right) and a current loop and itss associated magnetic field (left.)"}
